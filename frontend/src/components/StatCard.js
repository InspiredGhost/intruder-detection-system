...
export default function StatCard({ label, value, icon: Icon, color = 'blue', sub }) {
    ...
    return (_jsxs("div", { className: "bg-white border border-gray-200 rounded-xl p-5 flex items-start gap-4 shadow-sm hover:shadow-md transition-shadow", children: [_jsx("div", { className: `w-11 h-11 rounded-xl border-2 flex items-center justify-center shrink-0 ${scheme.icon}`, children: _jsx(Icon, { size: 20 }) }), _jsxs("div", { className: "min-w-0", children: [_jsx("p", { className: "text-gray-400 text-xs font-semibold uppercase tracking-wider", children: label }), _jsx("p", { className: `text-2xl font-bold mt-0.5 leading-tight ${scheme.value}`, children: value }), sub && _jsx("p", { className: "text-gray-400 text-xs mt-0.5", children: sub })] })] }));
}
